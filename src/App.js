...
const nodeTypes = {
  source: (props) => (
    <div className="bg-green-500 text-white p-3 border border-black">
      {props.data.label}
      <Handle type="source" position="right" className="w-3 h-3 bg-white" />
    </div>
  ),
  destination: (props) => (
    <div className="bg-red-400 text-white p-3 border border-black">
...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen">
      <div className="mt-4 mb-4 flex space-x-2  justify-center">
        <button
